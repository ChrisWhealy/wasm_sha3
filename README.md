...
Given that this implementation is a drop-in replacement for SHA2, the length `d` of the generated digest must exacly match digest lengths generated by SHA2.

...
| Size of data<br> in last block | Padding<br>marker | Padding<br>bits | Padding<br>string
|---|---|---|---
| `r-4` | `01` | `11` | `0111`
| `r-5` | `01` | `101` | `01101`
| `r-6` | `01` | `1001` | `011001`
...
| Size of data<br>in last block | Padding bits<br>in last block | Padding string<br>in extra block
|---|---|---
| `r-3` | `011` | `[r-1 * 0]1`
| `r-2` | `01` | `1[r-2 * 0]1`
| `r-1` | `0` | `11[r-3 * 0]1`

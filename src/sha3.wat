  ...
  (func $chi (export "chi")
    ...
    (loop $row_loop
      ...
      (loop $col_loop
        ...
        ;; (call $log.coords (local.get $debug_active) (local.get $fn_id) (i32.const 1) (local.get $col) (local.get $row+1))
        ;; (call $log.coords (local.get $debug_active) (local.get $fn_id) (i32.const 2) (local.get $col) (local.get $row+2))
